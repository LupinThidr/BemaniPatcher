...
with open('soundvoltex.dll', 'r+b') as soundvoltex:
    ...
    patch_multi(str.encode('../../plus/g/gmbg_2015_k01.ifs') + b'\x00' * 2)
    find_pattern(str.encode('game_bg/gmbg_kac5th_rasis.ifs'), 0x600000)
    patch_multi(str.encode('../../plus/g/gmbg_kac5th_ra.ifs') + b'\x00')
    find_pattern(str.encode('game_bg/gmbg_nishinippori.ifs'), 0x600000)
    patch_multi(str.encode('../../plus/g/gmbg_nishinip.ifs') + b'\x00' * 2)
    find_pattern(str.encode('game_bg/gmbg_tenkaichi03.ifs'), 0x600000)
    patch_multi(str.encode('../../plus/g/gmbg_tenkai03.ifs') + b'\x00' * 2)
    end()
