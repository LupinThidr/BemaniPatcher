...
for dll in Path(".").glob("soundvoltex*.dll"):
    ...
    with open(dll, "r+b") as infile:
        ...
        find_pattern(str.encode("FREE PLAY"), 0x600000)
        patch(title, "00" * 9)
        find_pattern(str.encode("EVENT MODE"), 0x600000)
        patch(title, "00" * 10)
        find_pattern(str.encode("TENKAICHI MODE"), 0x600000)
        patch(title, "00" * 14)
        find_pattern(str.encode("PASELI: %s + %s").hex(), 0x600000)
        patch(title, "00" * 15)
        find_pattern(str.encode("CREDIT: %d   COIN: %d / %d"), 0x600000)
        patch(title, "00" * 26)
        find_pattern(str.encode("CREDIT: %d\x00"), 0x600000)
        patch(title, "00" * 11)
        find_pattern(str.encode("PASELI: NOT AVAILABLE"), 0x600000)
        patch(title, "00" * 21)
        find_pattern(str.encode("PASELI: NO ACCOUNT"), 0x600000)
        patch(title, "00" * 18)
        find_pattern(str.encode("\x00PASELI: %s\x00"), 0x600000)
        patch(title, "00" * 12)
        find_pattern(str.encode("EXTRA PASELI: %s"), 0x600000)
        patch(title, "00" * 16)
        ...
        patch(title, "85", toggle_in_game=True)
        ...
        patch(title, "90" * 4, tooltip="v2.20")
        ...
        patch(title, str.encode("../../plus/g/gmbg_edp2016.ifs"))
        find_pattern(str.encode("game_bg/gmbg_kac5th_small.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_kac5th_s.ifs"))
        find_pattern(str.encode("game_bg/gmbg_omega18_maxma.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_omega18_m.ifs"))
        find_pattern(str.encode("game_bg/gmbg_omega_nianoa.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_omega_n.ifs"))
        ...
        patch(title, str.encode("../../plus/g/gmbg_diver_02_rishna.ifs"))
        find_pattern(str.encode("game_bg/gmbg_omega_inoten.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_omega_ino.ifs"))
        find_pattern(str.encode("game_bg/gmbg_2015_kac01.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_2015_k01.ifs"))
        find_pattern(str.encode("game_bg/gmbg_kac5th_rasis.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_kac5th_ra.ifs"))
        find_pattern(str.encode("game_bg/gmbg_nishinippori.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_nishinip.ifs"))
        find_pattern(str.encode("game_bg/gmbg_tenkaichi03.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_tenkai03.ifs"))
        find_pattern(str.encode("game_bg/gmbg_kac8th_lefrigh_s.ifs"), 0x600000)
        patch(title, str.encode("../../plus/g/gmbg_kac8th_lefrigh_s.ifs"))
